/**
 * SHULE CAFE - Global Translation Engine (100% English System)
...
export const translations = {
    en: {
        ...
        // ─── TOPBAR ──────────────────────────────────────────────────────────
        topbar: {
            platformName: 'Shule Cafe Platform',
            howdy:        'Howdy,',
            logout:       'Logout',
            langEn:       ' EN',
            langSw:       ' SW',
        ...
        profile: {
            ...
            role:               'Role',
            locked:             'Locked',
            editableSection:    'Editable Information',
            phone:              'Phone Number',
            email:              'Email Address',
            gender:             'Gender',
            male:               'Male',
        ...
        // ─── PROFILE ─────────────────────────────────────────────────────────
        profile: {
            breadcrumb:       'SHULE CAFE, My Profile',
            roleLabel:        'Role',
            schoolLabel:      'School',
...
export function getLang() {
    try { localStorage.setItem('shule_lang', 'en'); } catch(e) {}
    return 'en';
}
