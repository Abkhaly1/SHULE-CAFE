            ...
            <div class="table-toolbar" style="display:flex; justify-content:space-between; align-items:center; padding: var(--sp-4); background: var(--c-bg-surface); border-bottom: 1px solid var(--c-border-light);">
                <div class="toolbar-left" style="display:flex; gap: var(--sp-2);">
                    <div class="search-box" style="position:relative; display:inline-flex; align-items:center;">
                        ...
                        <input type="text" id="tableSearchInput" class="form-control toolbar-search-input" placeholder="${this.searchPlaceholder}" style="padding-left: 38px !important; height: 36px; min-width: 250px;">
                    </div>
                </div>
